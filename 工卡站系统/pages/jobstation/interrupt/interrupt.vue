	...
	<view style="background: linear-gradient(to right,#ffffff,#009dff)">
	   	 ...
	   	 <view class="t1">
				...
				<view class="t1p" style="width: 1000rpx;">
					...
					<button class="but" style="width: 200rpx;" @tap="interrupt" type="warn">中断</button>
                ...
                <view class="t2" style="width: 1400rpx;">
                	<view class="t3" style="width: 1400rpx;">
                		...
                		<view class="p4" style="width: 800rpx;">工单号/非例行号</view>
                	</view>
                	<view class="t3" style="width: 1400rpx;">
	...
	export default {
		...
		methods: {
			...
			selectjob:function(){
				...
				if(chec=="%%0"){
				this.jobValue = event.target.value.substring(3,14);
				}
				if(chec=="HGH"){
				this.jobValue = event.target.value.substring(3,16).toUpperCase();
				}
